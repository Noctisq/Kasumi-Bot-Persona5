module.exports = {
    ...
    async execute(message,args) {
      ...
      if(parseInt(args[0])>85) return message.channel.send("Es mucho volumen, senpai. Intenta con valores entre 0 y 85 :persevere:");
      dispatcher.setVolumeLogarithmic(parseInt(args[0])/100);
      message.reply(`Cambiando volumen de la música a: ${args[0]} , senpai :blush:`);
    },
  };
